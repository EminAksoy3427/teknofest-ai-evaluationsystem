...
function assertPageTexts(pageTexts) {
  if (!Array.isArray(pageTexts) || pageTexts.length === 0) {
    throw new Error("At least one synthetic PDF page is required");
  }
  if (!pageTexts.every((text) => typeof text === "string")) {
    throw new Error("Synthetic PDF page text must be a string");
  }
}
